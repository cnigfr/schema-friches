...
| -- | -- | -- |
| [site_id](#identifiant-du-site---propriété-site_id) | chaîne de caractères  | Oui |
...
| [site_ademe_url](#url-de-la-fiche-de-l’ademe---propriété-site_ademe_url) | chaîne de caractères (format `uri`) | Non |
...
| [site_projet_url](#site-web-d'un-éventuel-projet-sur-le-site---propriété-site_projet_url) | chaîne de caractères (format `uri`) | Non |
...
| [urba_zone_formedomi](#forme-dominante-de-la-zone---propriété-urba_zone_formedomi) | chaîne de caractères  | Non |
